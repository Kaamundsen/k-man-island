    ...
    <main className="min-h-screen p-8">
      ...
      <div className="mb-8">
        <div className="flex items-start justify-between mb-6">
          <div>
            <h1 className="text-5xl font-extrabold text-foreground tracking-tight mb-2">
              {tickerShort}
            </h1>
        ...
        <div className="lg:col-span-2">
          {activeTab === 'chart' && (
            <div className="space-y-6">
              ...
              {/* Loading State */}
              {chartLoading && (
                <div className="bg-card rounded-2xl p-12 border border-border flex items-center justify-center">
                  <Loader2 className="w-8 h-8 animate-spin text-brand-emerald" />
                  <span className="ml-3 text-muted-foreground">Laster historisk data...</span>
                </div>
              )}
              ...
              <div className="bg-card rounded-2xl p-6 border border-border">
                <h3 className="text-xl font-bold text-foreground mb-4">🔍 Teknisk Analyse</h3>
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-brand-emerald">{stock.target.toFixed(2)} {currency}</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span>Stop Loss:</span>
                      <span className="font-bold text-brand-rose">{stock.stopLoss.toFixed(2)} {currency}</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span>Risk/Reward Ratio:</span>
                      <span className="font-bold text-foreground">1:{(stock.gainKr / stock.riskKr).toFixed(2)}</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-6">
              {chartLoading && (
                <div className="bg-card rounded-2xl p-12 border border-border flex items-center justify-center">
                  ...
                  <span className="ml-3 text-muted-foreground">Analyserer SB-Levels...</span>
                </div>
              )}
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold">{isPositive ? '+' : ''}{stock.change.toFixed(2)} {currency}</span>
              </div>
              <div className="flex justify-between items-center">
